...
// The MCP9808 is a high accuracy I2C temperature sensor
...
void GetTemperature()
{
  ...
  float latestTempF = tempsensor.readTempF();
  
  tempsensor.shutdown_wake(1);
  
  // Now print the values:
  Serial.println("Temp(F): " + String(latestTempF, 1));
...
// TODO: Add parm for the specific MQTT channel
